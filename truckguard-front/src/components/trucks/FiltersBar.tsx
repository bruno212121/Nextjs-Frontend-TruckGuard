...
export default function FiltersBar({ search, onSearch, status, onStatusChange, onCreate, onCreateMaintenance }: Props) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      ...
      <Button onClick={onCreateMaintenance} className="bg-orange-600 hover:bg-orange-700 gap-2">
